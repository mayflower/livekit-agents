...
class RealtimeSession(llm.RealtimeSession):
    ...
    def _handle_usage_metadata(self, usage_metadata: types.UsageMetadata) -> None:
        ...
        # outside every modality bucket, and total_token_count is no help: the
        # SDK documents it as the sum of its parts, but measured against the
        # Live API it usually equals prompt + response with the thinking left
        # out. So thoughts_token_count is the only field that carries them.
